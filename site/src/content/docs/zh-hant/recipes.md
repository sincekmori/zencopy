...
## 單一供應商、單一模型 {#one-provider-one-model}
...
## 本機 Ollama——什麼都不離開你的電腦 {#local-ollama--nothing-leaves-your-machine}
...
## 兩個 role：預設求快，需要時求聰明 {#two-roles-fast-by-default-smart-on-demand}
