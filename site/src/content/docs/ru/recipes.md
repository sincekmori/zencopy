...
Роли отделяют действия от моделей.
Действие называет роль (`role: smart` в его frontmatter); какая модель за ней стоит, решается здесь — меняйте её в любой момент, не трогая действия.
