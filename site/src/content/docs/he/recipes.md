...
## ספק אחד, מודל אחד {#one-provider-one-model}
...
## Ollama מקומי — שום דבר לא עוזב את המחשב {#local-ollama--nothing-leaves-your-machine}
...
## שני roles: מהיר כברירת מחדל, חכם לפי דרישה {#two-roles-fast-by-default-smart-on-demand}

‏roles מנתקים את הקשר בין פרומפטים למודלים.
פרומפטים נוקבים בשם של role‏ (`role: smart` ב‑frontmatter של הפרומפט); איזה מודל זה אומר בפועל מוכרע כאן — החליפו אותו בכל עת בלי לגעת בפרומפטים.
