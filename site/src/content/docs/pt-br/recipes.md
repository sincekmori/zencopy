...
Roles desacoplam as ações dos modelos.
As ações nomeiam um role (`role: smart` no frontmatter da ação); qual modelo isso significa é decidido aqui — troque a qualquer momento sem tocar nas ações.
