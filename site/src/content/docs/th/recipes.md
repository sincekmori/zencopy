...
## ผู้ให้บริการเดียว โมเดลเดียว {#one-provider-one-model}
...
## Ollama ในเครื่อง — ไม่มีอะไรออกนอกเครื่องของคุณ {#local-ollama--nothing-leaves-your-machine}
...
## สอง role: เร็วเป็นค่าเริ่มต้น ฉลาดเมื่อต้องการ {#two-roles-fast-by-default-smart-on-demand}

role แยกพรอมต์ออกจากโมเดล
พรอมต์ระบุชื่อ role (`role: smart` ใน frontmatter ของพรอมต์) ส่วน role นั้นหมายถึงโมเดลไหนตัดสินกันที่นี่ — สลับได้ทุกเมื่อโดยไม่ต้องแตะพรอมต์เลย
